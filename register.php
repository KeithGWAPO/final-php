...
<head>
    ...
    <title>Green Coffee - Register Page</title>
</head>
<body>
        ...
        <section class="form-container">
            ...
            <form action="" method="post">
                <div class="input-field">
                    ...
                    <input type="text" name="name" required placeholder="Enter Your Name" maxlength="999"> 
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    ...
                    <input type="password" name="cpass" required placeholder="Enter Your Password" maxlength="999"
                    oninput="this.value = this.value.replace(/\s/g, '')"> 
                </div>
